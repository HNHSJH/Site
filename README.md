...
- Breadcrumb implementation follows [Google's documentation](https://developers.google.com/search/docs/appearance/structured-data/breadcrumb); responsive image selection follows [web.dev guidance](https://web.dev/articles/serve-responsive-images). Neither change guarantees rankings or a particular performance score.
